...
(define (problem hard1)
    ...
    (:init
        ...
        (blank x1 y2) (at t8 x1 y1) (at t7 x2 y3) (at t6 x1 y3)
        (at t5 x2 y1) (at t4 x2 y2) (at t3 x3 y2) (at t2 x3 y1) (at t1 x3 y3))
    
    
    (:goal  (and (at t1 x1 y2) (at t2 x1 y3) (at t3 x2 y1) (at t4 x2 y2) 
